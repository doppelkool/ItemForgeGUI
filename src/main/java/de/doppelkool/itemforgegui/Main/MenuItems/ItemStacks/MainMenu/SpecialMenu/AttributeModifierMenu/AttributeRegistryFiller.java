...
public class AttributeRegistryFiller {
	...
	public static List<AttributeItem> loadDefenseAndDurability() {
		...
		modifyItemFlags(armorItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		...
		modifyItemFlags(armorToughnessItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		defenseAndDurabilityItems.add(new AttributeItem(
			21,
		...
		modifyItemFlags(explosionKnockbackResistanceItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		defenseAndDurabilityItems.add(new AttributeItem(
			22,
		...
		modifyItemFlags(knockbackResistanceItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		defenseAndDurabilityItems.add(new AttributeItem(
			23,
		...
		modifyItemFlags(fallDamageMultiplierItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		defenseAndDurabilityItems.add(new AttributeItem(
			24,
		...
		modifyItemFlags(maxAbsorptionItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		defenseAndDurabilityItems.add(new AttributeItem(
			30,
		...
		modifyItemFlags(maxHealthItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
		...
		modifyItemFlags(safeFallDistanceItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		defenseAndDurabilityItems.add(new AttributeItem(
			32,
	...
	public static List<AttributeItem> loadCombat() {
		...
		modifyItemFlags(attackDamageItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
		...
		modifyItemFlags(attackKnockbackItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		combatItems.add(new AttributeItem(
			22,
		...
		modifyItemFlags(attackSpeedItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		combatItems.add(new AttributeItem(
			23,
		...
		modifyItemFlags(sweepingDamageRatioItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		combatItems.add(new AttributeItem(
			30,
		...
		modifyItemFlags(spawnReinforcementsItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
	...
	public static List<AttributeItem> loadMobility() {
		...
		modifyItemFlags(flyingSpeedItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
		...
		modifyItemFlags(gravityItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
		...
		modifyItemFlags(jumpStrengthItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
		...
		modifyItemFlags(movementSpeedItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		mobilityItems.add(new AttributeItem(
			23,
		...
		modifyItemFlags(sneakingSpeedItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		mobilityItems.add(new AttributeItem(
			24,
			sneakingSpeedItems,
		...
		modifyItemFlags(stepHeightItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		mobilityItems.add(new AttributeItem(
			30,
			stepHeightItems,
		...
		modifyItemFlags(waterMovementEfficiencyItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		mobilityItems.add(new AttributeItem(
			32,
	...
	public static List<AttributeItem> loadInteractionAndReach() {
		...
		modifyItemFlags(blockBreakSpeedItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		...
		modifyItemFlags(blockInteractionRangeItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		interactionAndReachItems.add(new AttributeItem(
			22,
		...
		modifyItemFlags(entityInteractionRangeItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		interactionAndReachItems.add(new AttributeItem(
			23,
		...
		modifyItemFlags(movementEfficiencyItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		interactionAndReachItems.add(new AttributeItem(
			30,
		...
		modifyItemFlags(miningEfficiencyItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		interactionAndReachItems.add(new AttributeItem(
			32,
	...
	public static List<AttributeItem> loadPerceptionAndAwareness() {
		...
		modifyItemFlags(cameraDistanceItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		...
		modifyItemFlags(followRangeItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		perceptionAndAwarenessItems.add(new AttributeItem(
			22,
			followRangeItems,
		...
		modifyItemFlags(temptRangeItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		perceptionAndAwarenessItems.add(new AttributeItem(
			23,
			temptRangeItems,
		...
		modifyItemFlags(waypointReceiveRangeItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		perceptionAndAwarenessItems.add(new AttributeItem(
			30,
		...
		modifyItemFlags(waypointTransmitRangeItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		perceptionAndAwarenessItems.add(new AttributeItem(
			32,
	...
	public static List<AttributeItem> loadEnvAndSurvival() {
		...
		modifyItemFlags(burningTimeItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		...
		modifyItemFlags(oxygenBonusItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		envAndSurvivalItems.add(new AttributeItem(
			22,
			oxygenBonusItems,
		...
		modifyItemFlags(luckItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		envAndSurvivalItems.add(new AttributeItem(
			23,
			luckItems,
			Attribute.LUCK));
		...
		modifyItemFlags(scaleItems, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);
		envAndSurvivalItems.add(new AttributeItem(
			31,
			scaleItems,
			Attribute.SCALE));
