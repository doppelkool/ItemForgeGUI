...
public class EditValueMenu extends ConfirmableMenu {
	...
	private static final List<SlotItemWrapper.SlotItemOperationValueEdit> INFO_BOOKS = List.of(
		new SlotItemWrapper.SlotItemOperationValueEdit(13, ModifyAttributeModifierItems.infoBook,AttributeModifier.Operation.ADD_NUMBER, null),
		new SlotItemWrapper.SlotItemOperationValueEdit(22, ModifyAttributeModifierItems.infoBook,AttributeModifier.Operation.ADD_SCALAR, null),
		new SlotItemWrapper.SlotItemOperationValueEdit(31, ModifyAttributeModifierItems.infoBook,AttributeModifier.Operation.MULTIPLY_SCALAR_1, null)
	);
	...
	private ItemStack fillInfoBookItemWithValues(SlotItemWrapper.SlotItemOperationValueEdit infoBook) {
		...
		Double currentValueForOperation = this.playerMenuUtility.getModifyAttributeStorage().getOperationDoubleValues().get(operation);
