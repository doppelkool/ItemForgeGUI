 ...
 */
public class MultiplyScalar1OperationMenu extends ConfirmableMenu {
	...
	public MultiplyScalar1OperationMenu(PlayerMenuUtility playerMenuUtility) {
		super(playerMenuUtility, 35);
		Double currentValue = this.playerMenuUtility.getAttributeStorage().getModifierValues().get(AttributeModifier.Operation.MULTIPLY_SCALAR_1);
		this.currentValue = currentValue != null ? currentValue : 0.0;
	}

	@Override
	public String getMenuName() {
		return "Edit value | Multiply Scalar 1 Operation";
	}
	...
	public void handleMenu(InventoryClickEvent e) {
		...
		if (super.handleConfirm(e.getSlot(),
			() -> this.playerMenuUtility.getAttributeStorage().getModifierValues().put(AttributeModifier.Operation.MULTIPLY_SCALAR_1, this.currentValue),
	...
	private ItemStack getInfoBook() {
		...
		ItemStackCreateHelper.modifyLore(infoCurrentValuesBook,
			...
			ChatColor.GRAY + "-> " + ChatColor.YELLOW + "Operation: Multiply Scalar 1 Operation",
